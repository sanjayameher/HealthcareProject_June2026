    ...
    <div className="flex h-screen bg-gray-50">
      <aside className={cn(
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-700">
          <div className="flex items-center justify-center w-8 h-8 bg-emerald-600 rounded-lg flex-shrink-0">
            <Heart className="w-4 h-4 text-white" />
          </div>
          {sidebarOpen && (
            <div className="overflow-hidden">
              <p className="text-sm font-bold text-white leading-tight">Doctor Portal</p>
