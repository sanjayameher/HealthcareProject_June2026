-- ============================================================
-- R__test_data — Repeatable Test Data
-- LOCAL DEV ONLY — DO NOT apply to staging or production.
-- This file is only loaded when the 'local' Spring profile is
-- active and db/testdata is in spring.flyway.locations.
-- Repeatable migrations re-run whenever the checksum changes.
-- ============================================================
