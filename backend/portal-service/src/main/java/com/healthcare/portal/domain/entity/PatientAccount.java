...
/**
 * Maps to dev.patient_accounts — used by portal-service for patient authentication.
 * Mirrors the patient-service entity but owned here for portal auth flows.
 */
@Entity
@Table(name = "patient_accounts", schema = "dev")
@Getter
@Setter
@NoArgsConstructor
